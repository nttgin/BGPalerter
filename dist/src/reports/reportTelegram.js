...
var reportTelegram = /*#__PURE__*/function (_ReportHTTP) {
  _inherits(reportTelegram, _ReportHTTP);

  var _super = _createSuper(reportTelegram);

  function reportTelegram(channels, params, env) {
    var _this;

    _classCallCheck(this, reportTelegram);

    var hooks = {};

    for (var userGroup in params.chatIds) {
    ...
    _this = _super.call(this, channels, telegramParams, env);
  ...
  return _createClass(reportTelegram);
}(_reportHTTP["default"]);

exports["default"] = reportTelegram;