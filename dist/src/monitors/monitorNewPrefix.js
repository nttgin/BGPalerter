...
var MonitorNewPrefix = /*#__PURE__*/function (_Monitor) {
  _inherits(MonitorNewPrefix, _Monitor);
  var _super = _createSuper(MonitorNewPrefix);
  function MonitorNewPrefix(name, channel, params, env, input) {
    ...
    _defineProperty(_assertThisInitialized(_this), "monitor", function (message) {
      return new Promise(function (resolve, reject) {
        ...
        if (matchedRule && !matchedRule.ignore && matchedRule.asn.includes(message.originAS) && !_ipSub["default"]._isEqualPrefix(matchedRule.prefix, messagePrefix)) {
...
exports["default"] = MonitorNewPrefix;