...
var Input = /*#__PURE__*/_createClass(function Input(env) {
  ...
  _defineProperty(this, "_reGeneratePrefixList", function () {
    ...
    return _this.retrieve().then(function (oldPrefixList) {
      ...
      inputParameters.logger = function (message) {// Nothing, ignore logs in this case (too many otherwise)
      };
      ...
      return (0, _generatePrefixesList["default"])(inputParameters).then(function (newPrefixList) {
        ...
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
            ...
            var newPrefix = newPrefixList[prefix]; // Apply old description to the prefix
  ...
  this.callbacks = [];
  this.prefixListDiffFailThreshold = 50; // This implements a fast basic fixed space cache, other approaches lru-like use too much cpu

  setInterval(function () {
    if (Object.keys(_this.cache.matched).length > 10000) {
      _this.cache.matched = {};
    }
  }, 10000); // This is to load the prefixes after the application is booted
